...
import static com.zhipu.face.config.ColorSelectionActivity.EXTRA_SHARED_PREF;
...
public class AnalogComplicationConfigRecyclerViewAdapter
    ...
    /**
     * Used by associated watch face ({@link ZhipuWatchFace}) to let this
    ...
    public AnalogComplicationConfigRecyclerViewAdapter(
            ...
            ArrayList<AnalogComplicationConfigData.ConfigItemType> settingsDataSet) {
        ...
        mBackgroundComplicationId =
                ZhipuWatchFace.getComplicationId(
                        ComplicationLocation.BACKGROUND);

        mLeftComplicationId =
                ZhipuWatchFace.getComplicationId(ComplicationLocation.LEFT);
        mRightComplicationId =
                ZhipuWatchFace.getComplicationId(ComplicationLocation.RIGHT);
        mBottomComplicationId =
                ZhipuWatchFace.getComplicationId(ComplicationLocation.BOTTOM);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        AnalogComplicationConfigData.ConfigItemType configItemType = mSettingsDataSet.get(position);
        ...
        switch (viewHolder.getItemViewType()) {
            case TYPE_PREVIEW_AND_COMPLICATIONS_CONFIG:
                ...
                AnalogComplicationConfigData.PreviewAndComplicationsConfigItem previewAndComplicationsConfigItem =
                        (AnalogComplicationConfigData.PreviewAndComplicationsConfigItem) configItemType;
            ...
            case TYPE_MORE_OPTIONS:
                ...
                AnalogComplicationConfigData.MoreOptionsConfigItem moreOptionsConfigItem =
                        (AnalogComplicationConfigData.MoreOptionsConfigItem) configItemType;
            ...
            case TYPE_UNREAD_NOTIFICATION_CONFIG:
                ...
                AnalogComplicationConfigData.UnreadNotificationConfigItem unreadConfigItem =
                        (AnalogComplicationConfigData.UnreadNotificationConfigItem) configItemType;
            ...
            case TYPE_BACKGROUND_COMPLICATION_IMAGE_CONFIG:
                ...
                AnalogComplicationConfigData.BackgroundComplicationConfigItem backgroundComplicationConfigItem =
                        (AnalogComplicationConfigData.BackgroundComplicationConfigItem) configItemType;
    ...
    public class PreviewAndComplicationsViewHolder extends RecyclerView.ViewHolder
        ...
        private void launchComplicationHelperActivity(
            ...
            mSelectedComplicationId =
                    ZhipuWatchFace.getComplicationId(complicationLocation);
            ...
            if (mSelectedComplicationId >= 0) {
                ...
                ComponentName watchFace =
                        new ComponentName(
                                currentActivity, ZhipuWatchFace.class);
        ...
        public void initializesColorsAndComplications() {
            ...
            final int[] complicationIds = ZhipuWatchFace.getComplicationIds();
